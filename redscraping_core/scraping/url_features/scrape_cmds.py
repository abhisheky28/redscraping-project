...
from .headings import run_headings_scraper
from .titles import run_titles_scraper
from .description import run_description_scraper
from .meta import run_meta_scraper
from .href import run_href_scraper
from .elements import run_elements_scraper
# Add to imports at the top:
from .all_text import run_all_text_scraper
from .status_code import run_status_scraper
...
@click.option('--format', 'output_format', type=click.Choice(['excel', 'csv', 'json', 'txt']), default='excel')
@click.option('--restart', is_flag=True, help="Ignore cache and start from scratch")
def status(input_file, output_format, restart):
    """Scrapes all visible, readable text from URLs."""
    run_status_scraper(input_file, output_format, restart)
